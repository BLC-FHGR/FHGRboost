...
$string['choosereadme'] = 'Theme htwboost is a child theme of Boost. It adds the ability to upload background htwboosts.';
// Name of the settings pages.
$string['configtitle'] = 'htwboost settings';
